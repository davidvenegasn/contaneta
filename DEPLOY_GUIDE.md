...
> **Consolidado en [OPERATIONS.md](docs/ops/OPERATIONS.md).** Para poner en marcha, checklist de producción (ENV, DEV_MODE, SESSION_SECRET, COOKIE_SECURE), systemd, backups y cron usa **OPERATIONS.md**.
